...
document.getElementById('copy2clipboard').addEventListener('click', function(){
    /* Get the text field */
    var copyText = document.getElementById("base64string");
...
function getBase64(file) { //Convert từ file thành base64
  ...
  reader.onload = function () {
    ...
    document.getElementById('base64string').value = reader.result;
